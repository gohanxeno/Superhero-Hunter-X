...
function getCharacters(){
    const char_url = `http://gateway.marvel.com/v1/public/characters?&ts=1&apikey=33c876ae27ef6588f206c92e7fa660e4&hash=7fba1d0b5613e9d5b4d2fad1db779422&limit=1`
    getCharApi(char_url)
}
getCharacters()
...
searchbar.onkeyup = function(event){
    ...
    if(userData!=''){
        ...
        var api_url = `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${userData}&ts=1&apikey=33c876ae27ef6588f206c92e7fa660e4&hash=7fba1d0b5613e9d5b4d2fad1db779422`
        getApi(api_url)
    }
...
function searchListFunc(data){
        ...
        for(let i=0;i<len;i++){
            ...
            li.innerHTML = 
                            `
                                <a href=${"char.html?character=" + data[i].id}git class="flex j-sb a-c" style="text-decoration:none;color:black;">
